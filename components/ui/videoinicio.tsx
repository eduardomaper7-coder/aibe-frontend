...
const VideoInicio: React.FC = () => {
  return (
    ...
    >
      {/* 💻 Marco del ordenador */}
      <div className="relative bg-gradient-to-b from-slate-800 to-slate-900 rounded-3xl shadow-[0_0_60px_rgba(0,0,0,0.6)] border border-slate-700 flex items-center justify-center p-4 md:p-6">
        {/* Pantalla interior */}
