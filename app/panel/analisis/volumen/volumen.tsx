    ...
    <div className="bg-white p-6 md:p-8 rounded-xl border border-gray-200 shadow-sm mx-auto max-w-[calc(100%-2rem)]">
      ...
      <ResponsiveContainer width="100%" height={360}>
        <ComposedChart data={data} margin={{ top: 10, right: 24, bottom: 12, left: 0 }}>
          ...
          <XAxis dataKey="mes" stroke="#475569" tick={{ fontSize: 12 }} axisLine={{ stroke: "#cbd5e1" }} tickLine={{ stroke: "#cbd5e1" }} />
          <YAxis
            yAxisId="left"
            orientation="left"
            stroke="#475569"
          ...
          <Bar yAxisId="right" dataKey="resenas" fill="#2563eb" barSize={36} radius={[6, 6, 0, 0]} name="Reseñas" />
          <Line yAxisId="left" type="monotone" dataKey="puntuacion" stroke="#0d9488" strokeWidth={2.5} dot={{ r: 3 }} activeDot={{ r: 5 }} name="Puntuación media" />
        </ComposedChart>
      </ResponsiveContainer>
    </div>
  );
