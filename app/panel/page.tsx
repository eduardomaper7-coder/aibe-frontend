...
function PanelUI() {
  ...
  const sectionIdByItem: Record<string, string | null> = {
    'Temas detectados': 'temas',
  ...
  return (
    <div className="min-h-screen w-full pb-12 bg-white">
      {/* Contenedor global con márgenes unificados */}
      <div className="px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-70">
                    Importaremos tus reseñas históricas y activaremos las respuestas automáticas de IA.
                  </p>
                </div>
              </div>
        ...
        <div className="relative">
          ...
          <div className={ !isConnected ? 'blur-sm select-none opacity-60' : ''}>
            ...
            <section id="sentimiento" className="scroll-mt-24 mt-10">
              <SentimientoSection />
            </section>

            <section id="oportunidades" className="scroll-mt-24 mt-10">
              <OportunidadesSection />
            </section>

            <section id="volumen" className="scroll-mt-24 mt-10">
              <VolumenSection />
            </section>

            <section id="respuestas" className="scroll-mt-24 mt-10">
              <RespuestasSection />
            </section>
          </div>
        </div>
